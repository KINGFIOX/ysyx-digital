...
public:
  ...
  CpuRam(Vtop *top, vluint64_t main_time, struct UART_STA *uart_status,
         const char *mem_path);
  ~CpuRam();
  ...
  inline void write4B(vluint64_t a, vluint64_t m, unsigned d) {
    write32(a, encwm32(m), d);
  }
  inline void write8B(vluint64_t a, vluint64_t m, vluint64_t d) {
    write64(a, encwm64(m), d);
  }
  ...
  int process_write128(vluint64_t main_time, vluint64_t a, vluint64_t m,
                       unsigned *d);
  ...
  int process_write(vluint64_t main_time, vluint64_t a, vluint64_t m,
                    unsigned *d);
  int process_write(vluint64_t main_time, vluint64_t a, vluint64_t m,
                    vluint64_t d);
  int process_write(vluint64_t main_time, vluint64_t a, vluint64_t m,
